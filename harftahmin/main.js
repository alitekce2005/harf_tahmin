const GameConfig = {
            categories: {
                "Hayvanlar": [
                    "köpek", "kedi", "balina", "aslan", "kuş", "fare", "tavşan", "ayı", "kaplan", "zebra",
                    "fil", "giraffe", "maymun", "penguen", "papağan", "kartal", "baykuş", "karga", "güvercin", "serçe",
                    "ördek", "kaz", "tavuk", "horoz", "hindi", "devekuşu", "flamingo", "pelikan", "şahin", "doğan",
                    "koyun", "keçi", "inek", "at", "eşek", "deve", "lama", "alpaka", "domuz", "sığır",
                    ...
                    "ahtapot", "mürekkepbalığı", "istiridye", "midye", "karides", "ıstakoz", "yengeç", "salyangoz", "solucan", "arı",
                    "kelebek", "tırtıl", "sinek", "sivrisinek", "eşek arısı", "karınca", "örümcek", "akrep", "çekirge", "cırcır böceği",
                    "kene", "pire", "bit", "hamster", "sincap", "porsuğun", "kunduz", "su samuru", "tilki", "kurt",
                    "hiena", "puma", "leopar", "jaguar", "çita", "aslan", "kaplan", "fil", "gergedan", "hipopotam"
                ],
                "Meyveler": [
                    "elma", "armut", "çilek", "portakal", "muz", "karpuz", "kavun", "ananas", "limon", "greyfurt",
                    "mandalina", "klementina", "tangerine", "üzüm", "kuru üzüm", "incir", "hurma", "kayısı", "şeftali", "nektarin",
                    "kiraz", "vişne", "çilek", "ahududu", "böğürtlen", "fındık", "ceviz", "badem", "fıstık", "antep fıstığı",
                    "hindistan cevizi", "kakao", "kestane", "yer fıstığı", "ayçiçeği", "susam", "keten", "chia", "kırmızı biber", "yeşil biber",
                    "domates", "patlıcan", "kabak", "mısır", "fasulye", "nohut", "mercimek", "arpa", "buğday", "çavdar",
                    "avokado", "mango", "papaya", "kiwi"
                ],
                "Şehirler": [
                    "ankara", "istanbul", "izmir", "antalya", "bursa", "adana", "gaziantep", "konya", "kayseri", "samsun",
                    "diyarbakır", "erzurum", "trabzon", "rize", "ordu", "giresun", "sinop", "çorum", "amasya", "tokat",
                    "sivas", "malatya", "elazığ", "bingöl", "tunceli", "erzincan", "bayburt", "gümüşhane", "rize", "artvin",
                    "ardahan", "kars", "iğdır", "ağrı", "van", "bitlis", "siirt", "şırnak", "mardin", "batman",
                    ...
                    "kütahya", "uşak", "isparta", "burdur", "mersin", "adıyaman", "kahramanmaraş", "hatay", "kilis", "osmaniyeleri",
                    "niğde", "nevşehir", "kırşehir", "aksaray", "yozgat", "çankırı", "kastamonu", "karabük", "zonguldak", "bartın",
                    "düzce", "bolu", "sakarya", "kocaeli", "yalova", "bilecik", "eskişehir", "afyon", "kütahya", "uşak",
                    "manisa"
                ],
                "Meslekler": [
                    "doktor", "öğretmen", "mühendis", "hemşire", "pilot", "aşçı", "garson", "berber", "kuaför", "terzi",
                    "elektrikçi", "tesisatçı", "marangoz", "boyacı", "cam ustası", "çatı ustası", "usta", "kalfa", "çırak", "işçi",
                ...
                "Spor": [
                    ...
                    "amerikan futbolu", "beyzbol", "kriket", "golf", "bowling", "bilardo", "dart", "curling", "buz hokeyi", "paten",
                    "kayak", "snowboard", "buz pateni", "dağ tırmanışı", "kaya tırmanışı", "paraşüt", "paragliding", "yelkencilik", "sörf", "windsurf",
                    "dalış", "snorkeling", "kano", "rafting", "kayaking", "su topu", "su polo", "sinkro yüzme", "dalış", "atıcılık",
                    ...
                    "yürüyüş", "kros", "orienteering", "dağ koşusu", "sokak koşusu", "buz pisti", "dressage", "atlı spor", "polo", "cirit",
                    "boks", "muay thai", "karate", "judo", "taekwondo", "güreş", "sumo", "kendo", "esgrim", "kılıç",
                    "bisiklet", "dağ bisikleti", "pist bisikleti", "BMX", "motosiklet", "motorsiklet yarışı", "formula 1", "rallisi", "drifti", "kart",
                    "bungee jumping", "zip line", "sörfçülük", "wakeboard", "su kayağı", "jet ski", "denizcilik", "yelkenli", "kayık", "sandal"
                ],
                "Yemekler": [
                    "pizza", "hamburger", "döner", "kebab", "manti", "börek", "gözleme", "pide", "lahmacun", "tatlı",
                    ...
                    "meze", "hummus", "baba ganoush", "cacık", "tzatziki", "tarama", "salatası", "çoban salatası", "patlıcan salatası", "domates salatası",
                    "salata", "yeşil salata", "kırmızı lahana salatası", "coleslaw", "karpuz salatası", "buğday salatası", "tabbouleh", "falafel", "kibbeh", "şiş",
                    "adana kebab", "urfa kebab", "şiş kebab", "doner kebab", "tavuk döner", "kıyma döner", "beyti", "inegöl köfte", "çiğ köfte", "kofta",
                    "kuru fasulye", "nohut", "mercimek", "bulgur", "pilav", "pirinç", "makarna", "spagetti", "penne", "fusilli",
                    "ravioli", "tortellini", "lasagna", "cannelloni", "gnocchi", "risotto", "paella", "couscous", "bulgur pilavı", "sebzeli pilav",
                    "tavuk", "et", "balık", "karides", "midye", "ahtapot", "mürekkepbalığı", "istiridye", "salyangoz", "rana",
                    "sucuk", "salam", "jambon", "pastırma", "sosis", "sosisli", "corned beef", "pastrami", "prosciutto", "pancetta"
                ],
                "Araçlar": [
                    "Toyota", "Honda", "Nissan", "Mazda", "Subaru", "Mitsubishi",
                    "Ford", "General Motors", "Chevrolet", "GMC", "Cadillac", "Buick",
                    "Volkswagen", "Audi", "BMW", "Mercedes-Benz", "Porsche", "Lamborghini",
                    "Ferrari", "Maserati", "Alfa Romeo", "Fiat", "Lancia", "Jeep",
                    "Renault", "Peugeot", "Citroën", "DS", "Opel", "Vauxhall",
                    "Volvo", "Scania", "Saab", "Koenigsegg", "Pagani", "Bugatti",
                    "Hyundai", "Kia", "Daewoo", "SsangYong", "Geely", "BYD",
                    "Chery", "JAC", "Great Wall", "Li Auto", "NIO", "XPeng",
                    "Tesla", "Rivian", "Lucid", "Fisker", "Canoo", "Arrival",
                    "Suzuki", "Daihatsu", "Isuzu", "UD Trucks", "Hino", "Fuso",
                    "Harley-Davidson", "Yamaha", "Kawasaki", "Suzuki", "Honda", "KTM",
                    "Ducati", "BMW Motorrad", "Triumph", "Royal Enfield", "Bajaj", "Hero"
                ],
                "Bölümler": [
                    "yazılım geliştirme", "bilgisayar mühendisliği", "bilgisayar bilimleri", "veri bilimi", "yapay zeka", "siber güvenlik",
                    "tıp", "diş hekimliği", "veterinerlik", "eczacılık", "hemşirelik", "fizyoterapı",
                    ...
                    "İngilizce", "Türkçe", "Almanca", "Fransızca", "İspanyolca", "Çince", "Arapça"
                ]
            },
            difficulties: {
